...
| `socrataApiUrl`                             | Socrata API URL                                                                                                  | `https://data.ny.gov/resource/p66s-i79p.json`                    |
| `localRegistryToUse`                        | Registry that local instance's company number is registered with                                                 | `GB`                                                             |
...
| `image.tag`                                       | veritable-ui image tag (immutable tags are recommended)                                                                                                 | `v0.18.12`                  |
