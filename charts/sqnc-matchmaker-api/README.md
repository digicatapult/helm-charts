...
| `roles`                                           | specifies which roles we assume for access control, comma separated for e.g. ['optimiser','member-a']  will assume the role of an optimiser and member-a                                                 | `['admin']                         |
...
| `image.tag`                                       | sqnc-matchmaker-api image tag (immutable tags are recommended)                                                                                                                                           | `v6.2.9`                           |
