...
| `inboundTransport`                       | choice of inbound transport mechanisms for veritable-cloudagent can be http, ws, or both in a comma delimited string                                                                                                             | `http`                          |
...
| `personaColorl`                          | veritable-cloudagent represents current persona                                                                                                                                                                                  | `white`                         |
...
| `verifiedDrpcOptionsProofRequestOptions` | veritable-cloudagent TODO this meant to be a JSON object -> https://github.com/digicatapult/veritable-cloudagent/blob/main/src/env.ts#L94                                                                                        | `""`                            |
