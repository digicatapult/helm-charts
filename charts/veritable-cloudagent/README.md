...
| `ipfs.image.tag`                          | IPFS image tag (immutable tags are recommended)                                                                                                                                          | `v0.39.0`                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| `ipfs.initConfig.binary`                  | IPFS binary path                                                                                                                                                                         | `/usr/local/bin/ipfs`                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| `ipfs.persistence.subPath`                | IPFS PVC sub path                                                                                                                                                                        | `""`                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| `image.tag`                                       | veritable-cloudagent image tag (immutable tags are recommended)                                                                                                 | `v0.18.3`                           |
