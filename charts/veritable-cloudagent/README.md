...
### veritable Identity Service config parameters
...
| `image.tag`                                       | veritable-cloudagent image tag (immutable tags are recommended)                                                                                                 | `v2.3.0`                           |
...
| `containerPorts.http`                             | veritable-cloudagent HTTP container port                                                                                                                        | `3000`                             |
...
| `service.ports.http`               | veritable-cloudagent service HTTP port                                                                                            | `3000`                      |
...
| `externalDatabase.user`                              | Non-root username for veritable-cloudagent                                | `matchmaker_service` |
| `externalDatabase.password`                          | Password for the non-root username for veritable-cloudagent               | `""`                 |
| `externalDatabase.database`                          | veritable-cloudagent database name                                        | `matchmaker`         |
...
### veritable-Node Parameters

| Name                    | Description                                                                               | Value  |
| ----------------------- | ----------------------------------------------------------------------------------------- | ------ |
| `node.enabled`          | Enable veritable-Node subchart                                                                 | `true` |
| `node.nameOverride`     | String to partially override veritable-node.fullname template (will maintain the release name) | `""`   |
| `node.fullnameOverride` | String to fully override veritable-node.fullname template                                      | `""`   |
| `externalveritableNode.host` | External veritable-Node hostname to query                                                      | `""`   |
| `externalveritableNode.port` | External veritable-Node port to query                                                          | `""`   |

### veritable-Ipfs parameters

| Name                    | Description                 | Value |
| ----------------------- | --------------------------- | ----- |
| `externalveritableIpfs.host` | External veritable-Ipfs hostname | `""`  |
| `externalveritableIpfs.port` | External veritable-Ipfs port     | `""`  |

### veritable-Identity-Service parameters

| Name                        | Description                             | Value |
| --------------------------- | --------------------------------------- | ----- |
| `externalveritableIdentity.host` | External veritable-Identity-Service hostname | `""`  |
| `externalveritableIdentity.port` | External veritable-Identity-Service port     | `""`  |
